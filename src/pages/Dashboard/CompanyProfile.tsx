...
export default function CompanyProfile() {
  ...
  const submitHandler = async (e: any) => {
    ...
    const data = {
      ...
      "totalEvents": company.totalEvents,
      "teamMembers": company.teamMembers,
      "address": company.address,
      "aboutCompany": company.address
    }

    try {

      const results = await apiClient.put(`/admin/Companies/1`, data)
  ...
  const fetchCompany = async () => {
    ...
    try {
      ...
      setCompany({
        ...
        totalEvents: data.totalEvents?.toString() || "",
        teamMembers: data.teamMembers?.toString() || "",
